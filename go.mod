...
replace (
	...
	// CNPG bumps the deps in controller-runtime and k8s.io. We still need to use v0.35.6.
	// KEDA v2.20+ requires controller-runtime v0.23.3+.
	// Pin k8s.io dependencies to v0.35.6 and controller-runtime to v0.23.3
...
require (
	...
	github.com/libopenstorage/secrets v0.0.0-20260901190741-925417d11ff0
